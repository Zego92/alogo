...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'link'                  => 'Ссылка',
        'start_time_work'       => 'Время Открытия',
        'end_time_work'         => 'Время Закрытия',
        'rank'                  => 'Рекомендация',
        'carId'                 => 'Автопроизводитель',
        'parentId'              => 'Тип Категории',
        'categoryId'            => 'Категория',
        'brand'                 => 'Производитель',
        'article'               => 'Каталожный номер',
        'status'                => 'Статус',
        'phone1'                => 'Контактный телефон',
        'location'              => 'Ссылка на Google Maps',
        'startTimeWork'         => 'Время начала работы',
        'endTimeWork'           => 'Время конца работы',
    ],
];
